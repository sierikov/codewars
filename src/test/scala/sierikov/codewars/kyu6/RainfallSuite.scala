...
import sierikov.codewars.kyu6.RainfallSuite.*

class RainfallSuite extends AnyFunSuite with Matchers {
  test("Rainfall.mean should calculate mean correctly") {
    Rainfall.mean("London", data) should equal(51.199999999999996 +- 1e-2)
  }

  test("Rainfall.variance should calculate variance correctly") {
    Rainfall.variance("London", data) should equal(57.42833333333374 +- 1e-2)
  }
}

object RainfallSuite {
  var data: String =
  ...
  var data1
    : String = "Rome:Jan 90.2,Feb 73.2,Mar 80.3,Apr 55.7,May 53.0,Jun 36.4,Jul 17.5,Aug 27.5,Sep 60.9,Oct 147.7,Nov 121.0,Dec 97.9" + "\n" +
  ...
  var towns: Array[String] = Array("Rome",
                                   "London",
                                   "Paris",
                                   "NY",
                                   "Vancouver",
